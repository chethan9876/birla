...
`aws eks --region ap-southeast-2 update-kubeconfig --name stg-au-qld-eks --profile au-qld`
...
helm template eks-release -n kube-system -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml . > test.yaml

# To install
helm install eks-release  --namespace kube-system  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .


# To upgrade the chart
helm diff upgrade eks-release --namespace kube-system  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
# make sure only your changes are there then run
helm upgrade eks-release --namespace kube-system  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
...
helm template base-release -n base -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml . > test.yaml

# To install
helm install base-release  --namespace base  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .

# To upgrade the chart.
helm diff upgrade base-release --namespace base -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
# make sure only your changes are there then run
helm upgrade base-release --namespace base -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
...
helm template monitoring-release  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml -n monitoring . > test.yaml

# To install
helm install monitoring-release -n monitoring  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .

# To upgrade the chart when new subchart is added.
helm diff upgrade monitoring-release -n monitoring   -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
# make sure only your changes are there then run
helm upgrade monitoring-release -n monitoring   -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
...
helm template . -n alcyon-release  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml --namespace alcyon-app > test.yaml

helm install --debug --dry-run alcyon-release -n alcyon-app  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .

# To install
helm install alcyon-release -n alcyon-app  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .

# To upgrade the chart
helm diff upgrade alcyon-release -n alcyon-app  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
# make sure only your changes are there then run
helm upgrade alcyon-release -n alcyon-app  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
...
helm template . -n au-qld-release  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml --namespace alcyon-app > test.yaml

helm install --debug --dry-run au-qld-release -n au-qld  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .

# To install
helm install au-qld-release -n au-qld  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .

# To upgrade the chart
helm diff upgrade au-qld-release -n au-qld  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
# make sure only your changes are there then run
helm upgrade au-qld-release -n au-qld  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
...
helm template  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml . -n utility-release --namespace utility > test.yaml

helm install --debug --dry-run utility-release --namespace utility  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .

# To install
helm install utility-release --namespace utility  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .

# To purge the release
helm uninstall -n utility utility-release

# To run upgrade.
helm diff upgrade utility-release --namespace utility  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
# make sure only your changes are there then run
helm upgrade utility-release --namespace utility  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
...
helm template -f ../values-stg-au-qld-global.yaml  -f values-stg-au-qld.yaml . -n migration-release --namespace migration > test.yaml

helm install --debug --dry-run -n migration-release --namespace migration -f ../values-stg-au-qld-global.yaml  -f values-stg-au-qld.yaml .

# To install
helm install migration-release --namespace migration -f ../values-stg-au-qld-global.yaml  -f values-stg-au-qld.yaml .

# To purge the release
helm uninstall -n migration migration-release

# To run upgrade.
helm diff upgrade migration-release --namespace migration -f ../values-stg-au-qld-global.yaml  -f values-stg-au-qld.yaml .
# make sure only your changes are there then run
helm upgrade migration-release --namespace migration -f ../values-stg-au-qld-global.yaml  -f values-stg-au-qld.yaml .
````
...
helm template  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml . -n arm-release --namespace arm > test.yaml

helm install --debug --dry-run -n arm-release --namespace arm  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .

# To install
helm install arm-release --namespace arm  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .

# To purge the release
helm uninstall -n arm arm-release

# To run upgrade.
helm diff upgrade arm-release --namespace arm  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
# make sure only your changes are there then run
helm upgrade arm-release --namespace arm  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
...
helm template  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml . -n stub-release --namespace stub > test.yaml

helm install --debug --dry-run -n stub-release --namespace stub  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .

# To install
helm install stub-release --namespace stub  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .

# To purge the release
helm uninstall -n stub stub-release

# To run upgrade.
helm diff upgrade stub-release --namespace stub  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
# make sure only your changes are there then run
helm upgrade stub-release --namespace stub  -f ../values-stg-au-qld-global.yaml -f values-stg-au-qld.yaml .
