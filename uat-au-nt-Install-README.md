...
`aws eks --region ap-southeast-2 update-kubeconfig --name uat-au-nt-eks --profile au-nt`
...
kubectl create secret docker-registry regsecret --docker-server=dockerp.rtsprod.net --docker-username=redflex --docker-password=redflex --docker-email=cst@redflex.com -n monitoring
...
helm template eks-release -n kube-system -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml . > test.yaml

# To install
helm install eks-release  --namespace kube-system  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .


# To upgrade the chart
helm diff upgrade eks-release --namespace kube-system  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
# make sure only your changes are there then run
helm upgrade eks-release --namespace kube-system  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
...
helm template base-release -n base -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml . > test.yaml

# To install
helm install base-release  --namespace base  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .

# To upgrade the chart.
helm diff upgrade base-release --namespace base -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
# make sure only your changes are there then run
helm upgrade base-release --namespace base -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
...
helm template monitoring-release  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml -n monitoring . > test.yaml

# To install
helm install monitoring-release -n monitoring  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .

# To upgrade the chart when new subchart is added.
helm diff upgrade monitoring-release -n monitoring   -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
# make sure only your changes are there then run
helm upgrade monitoring-release -n monitoring   -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
...
helm template . -n alcyon-release  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml --namespace alcyon-app > test.yaml

helm install --debug --dry-run alcyon-release -n alcyon-app  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .

# To install
helm install alcyon-release -n alcyon-app  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .

# To upgrade the chart
helm diff upgrade alcyon-release -n alcyon-app  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
# make sure only your changes are there then run
helm upgrade alcyon-release -n alcyon-app  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
...
helm template . -n au-nt-release  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml --namespace alcyon-app > test.yaml

helm install --debug --dry-run au-nt-release -n au-nt  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .

# To install
helm install au-nt-release -n au-nt  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .

# To upgrade the chart
helm diff upgrade au-nt-release -n au-nt  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
# make sure only your changes are there then run
helm upgrade au-nt-release -n au-nt  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
...
helm template  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml . -n utility-release --namespace utility > test.yaml

helm install --debug --dry-run utility-release --namespace utility  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .

# To install
helm install utility-release --namespace utility  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .

# To purge the release
helm uninstall -n utility utility-release

# To run upgrade.
helm diff upgrade utility-release --namespace utility  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
# make sure only your changes are there then run
helm upgrade utility-release --namespace utility  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
...
helm template -f ../values-uat-au-nt-global.yaml  -f values-uat-au-nt.yaml . -n migration-release --namespace migration > test.yaml

helm install --debug --dry-run -n migration-release --namespace migration -f ../values-uat-au-nt-global.yaml  -f values-uat-au-nt.yaml .

# To install
helm install migration-release --namespace migration -f ../values-uat-au-nt-global.yaml  -f values-uat-au-nt.yaml .

# To purge the release
helm uninstall -n migration migration-release

# To run upgrade.
helm diff upgrade migration-release --namespace migration -f ../values-uat-au-nt-global.yaml  -f values-uat-au-nt.yaml .
# make sure only your changes are there then run
helm upgrade migration-release --namespace migration -f ../values-uat-au-nt-global.yaml  -f values-uat-au-nt.yaml .
...
helm template  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml . -n arm-release --namespace arm > test.yaml

helm install --debug --dry-run -n arm-release --namespace arm  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .

# To install
helm install arm-release --namespace arm  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .

# To purge the release
helm uninstall -n arm arm-release

# To run upgrade.
helm diff upgrade arm-release --namespace arm  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
# make sure only your changes are there then run
helm upgrade arm-release --namespace arm  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
...
helm template  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml . -n stub-release --namespace stub > test.yaml

helm install --debug --dry-run -n stub-release --namespace stub  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .

# To install
helm install stub-release --namespace stub  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .

# To purge the release
helm uninstall -n stub stub-release

# To run upgrade.
helm diff upgrade stub-release --namespace stub  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
# make sure only your changes are there then run
helm upgrade stub-release --namespace stub  -f ../values-uat-au-nt-global.yaml -f values-uat-au-nt.yaml .
