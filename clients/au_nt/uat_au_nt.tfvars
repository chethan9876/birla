...
eks_cluster_worker_node_ssh_key                        = "uat-au-nt-core-apps-eks-key"
eks_cluster_admin_additional_ingress_security_group_id = "" # To SSH from Jump Box to Admin Box
jumpbox_ssh_key                                        = "uat-au-nt-core-apps-eks-key"
eks_version                                            = 1.24
...
domaincontroller_ssh_key                               = "uat-au-nt-dc-ec2-key"
domaincontroller_securitygroup_ingress_ports = [
  {
    protocol = "tcp"
    from_port = "3389"
    to_port = "3389"
    cidr_blocks = ["192.168.112.0/20"]
...
//adconnector
activedirectoryname = "uatredflexnt.com"
...
itservice_ssh_key                               = "uat-au-nt-itsvc-ec2-key"
...
subnet_short         = ""
vpc_cidr             = "192.168.112.0/20"
additional_vpc_cidr  = "192.168.216.0/24"
...
//subnets
subnets_dmz = {
  "ap-southeast-2a" = "192.168.121.0/24",
  "ap-southeast-2b" = "192.168.122.0/24"
}
subnets_internal = {
  "ap-southeast-2a" = "192.168.216.0/26",
  "ap-southeast-2b" = "192.168.216.64/26",
  "ap-southeast-2c" = "192.168.216.128/26"
}
subnets_database = {
  "ap-southeast-2a" = "192.168.112.0/24",
  "ap-southeast-2b" = "192.168.113.0/24",
  "ap-southeast-2c" = "192.168.114.0/24"
}
subnets_approach = {
  "ap-southeast-2a" = "192.168.125.0/24"
}
subnets_secure = {
  "ap-southeast-2a" = "192.168.126.0/24"
}
subnets_workspaces = {
  "ap-southeast-2a" = "192.168.118.0/24",
  "ap-southeast-2b" = "192.168.119.0/24"
}
...
internal_routes = [
  {
    cidr_block                 = null
    destination_prefix_list_id = "pl-0c9a69dba34bd3bea"
    ipv6_cidr_block            = null
    carrier_gateway_id         = null
    egress_only_gateway_id     = null
    gateway_id                 = null
