...
assumer_roles    = ["arn:aws:iam::580626776770:role/dot/bis/apps/d8001-dev-traffic-infringement-management-API-access",
  "arn:aws:iam::639477429851:role/Role_1_WAPOL_Account"]
...
db_instance_count                 = 1
db_snapshot_identifier            = "uat-au-wa-alcyon-backoffice-rds-20230330"
msk_version = "2.6.2"
msk_instance_type = "kafka.t3.small"
msk_ebs_size = "1000"

alcyon_report_db_engine_version                 = "11.17"
...
alcyon_records_manager_db_engine_version                 = "11.17"
...
eks_cluster_worker_node_ssh_key                        = "sys-au-wa-core-apps-eks-key"
eks_cluster_admin_additional_ingress_security_group_id = "" # To SSH from Jump Box to Admin Box
jumpbox_ssh_key                                        = "sys-au-wa-core-apps-eks-key"
eks_version                                            = 1.22
...
domaincontroller_ssh_key                               = "sys-au-wa-dc-ec2-key"
domaincontroller_securitygroup_ingress_ports = [
  {
    protocol = "tcp"
    from_port = "3389"
    to_port = "3389"
    cidr_blocks = ["10.145.0.0/16"]
...
//adconnector
activedirectoryname = "sysredflexwa.com"
...
itservice_ssh_key                               = "sys-au-wa-itsvc-ec2-key"
